...
<Paragraph className="text-neutral-700 text-sm md:text-lg max-w-md py-2">
<Heading as="h2"className="font-black text-lg md:text-lg lg:text-lg mt-8 mb-4">Research</Heading>
