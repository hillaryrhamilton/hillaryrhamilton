  ...
  return (
    <Container>
      ...
      <div className="max-w-7xl mx-auto pb-20 px-4 md:px-8 lg:px-10">
        ...
        <Paragraph className="text-neutral-700 text-sm md:text-base max-w-7xl py-2">
...
<Paragraph className="text-neutral-700 text-sm md:text-base max-w-7xl py-2">
<Heading as="h2"className="font-black text-lg md:text-xl mt-8 mb-4">Teaching</Heading>
