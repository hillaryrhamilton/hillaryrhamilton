...
const ORCiDLogo = () => {
    return (
        <svg id="Layer_1" style={{"enableBackground":"new 0 0 256 256"}} version="1.1" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" xmlSpace="preserve">
	<style type="text/css">.st0{fill:#A6CE39;} .st1{fill:#FFFFFF;}</style>
	<path className="st0" d="M256,128c0,70.7-57.3,128-128,128C57.3,256,0,198.7,0,128C0,57.3,57.3,0,128,0C198.7,0,256,57.3,256,128z"/>
	<g>
