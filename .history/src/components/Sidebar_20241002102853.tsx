  ...
  return (
    <>
      <div
        ...
        } transition-transform duration-300 ease-in-out fixed top-0 left-0 h-screen bg-neutral-100 w-64 overflow-y-auto`}
      >
      ...
      <button
        className="fixed top-4 left-4 p-2 bg-white rounded-full shadow-md"
